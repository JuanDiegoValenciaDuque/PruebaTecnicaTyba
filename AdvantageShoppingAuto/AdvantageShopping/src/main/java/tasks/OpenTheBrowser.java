...
import questions.ShoppingVisible;
...
public class OpenTheBrowser implements Task{
	...
	@Override
	@Step("that {0} is in AdvantageShopping home page") 
	public <T extends Actor> void performAs(T actor) {		
		actor.attemptsTo(Open.browserOn(page)); 
		actor.should(seeThat(ShoppingVisible.isVisible()).orComplainWith(NoInternetConnection.class,
